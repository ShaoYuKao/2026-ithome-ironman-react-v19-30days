// Day22 範例後端：延續 Day21 的 Express API，只提供一支「商品搜尋」端點，
// 讓「商品搜尋」路由頁面（SearchPage）可以練習 useDebounce 與 useFetch
// 這兩個自訂 Hook 搭配使用。
//
// 刻意設計了兩個重點，呼應 Day21「效能優化」的主題：
...
app.get('/api/products', async (req, res) => {
  ...
  console.log(`[day22-router-lab] GET /api/products?q=${keyword || '(空字串，回傳全部)'}`)
...
app.listen(PORT, () => {
  console.log(`[day22-router-lab] Express server ready at http://localhost:${PORT}`)
})
