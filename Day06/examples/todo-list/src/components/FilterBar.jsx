function FilterBar({ filter, onChangeFilter, remainingCount }) {
  return (
    <div className="filter-bar">
      <div className="filter-buttons">
        {/* 三元運算子：依目前的 filter 決定要不要加上 --active 樣式 */}
        <button
          type="button"
